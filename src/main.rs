...
fn main(){
    ...
    println!("{}",parser_se_config::get_cnfig_int(&config, "Shen", "Freq2"));
    println!("{}",parser_se_config::get_cnfig_string(&config, "Shen.Eternity", "Gover"));
    println!("{}",parser_se_config::get_config_bool(&config, "Shen.Eternity", "endle"));
    println!(".......................");
    println!("{}",parser_se_config::get_cnfig_int(&config, "Shen.Eternity", "Gover"));
    println!("{}",parser_se_config::get_cnfig_string(&config, "Shen", "Freq"));
